...
<html data-wf-page="5e7092bf4210733168e6094c" data-wf-site="5e7092bf421073025be60948">
<head>
  <meta charset="utf-8">
  <?php
  ...
  <?php
    ...
    ?>
  <meta content="MovieInfo" property="og:title">
...
<body>
  <div class="section-3">
    ...
    <div class="main-block movie2">
      <div class="div-block-11">
        <div class="container-6 w-container">
          <div class="thumb-div">
            <img src="<?php echo implode(",",$Thumbnail); ?>" sizes="300px" alt="" class="image-2">
          </div>
          <div class="div-block-12">
            <div class="div-lightbox">
              <a href="#" class="w-inline-block w-lightbox">
                <img src="images/play_button_circled_60px_1play_button_circled_60px.png" width="76" alt="" class="image-3">
            ...
            <div class="wrapper">
              <div class="div-content slide1">
                ...
                <div class="div-book"><a href="movie2-book.php" class="button w-button">Book Now!</a>
