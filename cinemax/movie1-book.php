                    ...
                    <div class="wrapper-book">
                      <div class="div-block-17">
                        ...
                        <div class="div-block-32">
                          ...
                          <div class="w-form">
                            <form action="insert-bookings.php" method="post" id="email-form" name="email-form" data-name="Email Form" class="form-3">
                              ...
                              <input type="text" class="text-field-3 w-input" maxlength="256" name="number" placeholder="09*********" id="number" required="">
...
var elems1 = document.getElementsByClassName("heading-7");
    ...
    <?php
    $seat_queery = "SELECT `seat` FROM `bookings`";
    $seat_result = mysqli_query($conn, $seat_queery);
    ...
    ?>
        ...
        document.getElementById('<?php echo $seatsold; ?>').style.pointerEvents = 'none';
    <?php
      }
    }
